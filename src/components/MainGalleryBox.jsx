        ...
        <div className="gallery-box">
            <Carousel fade controls={false} indicators={false} pause={false} className='main-carousel'>
                <Carousel.Item interval={2000}>
                    <StaticImage alt='slika' src='../assets/images/osnovne/q1-1.jpg' aspectRatio={16/9} className="slika" placeholder="blurred"
                                 layout="CONSTRAINED" />
                </Carousel.Item>
                <Carousel.Item interval={2000}>
                    <StaticImage alt='slika' src='../assets/images/osnovne/q2-1.jpg' aspectRatio={16/9} className="slika" placeholder="blurred"
                                 layout="CONSTRAINED" />
                </Carousel.Item>
            </Carousel>
